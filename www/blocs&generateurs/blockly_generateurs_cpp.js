...
Blockly.Arduino['ps2x_block']=function(block){
    var valueps2x = Blockly.Arduino.statementToCode(block, 'PS2x');
    var valueps2xxs = block.getFieldValue('PS2xxs');
    Blockly.Arduino.includes_['includes_ps2x_block'] = '#include <PS2X_lib.h> \n   PS2X ps2x; \n int error = 0; \n  byte type = 0;\n int vibrate = 0; \n ';
    Blockly.Arduino.setups_['setups_ps2x_block']='  error = ps2x.config_gamepad(13,11,10,12, true, true);    \n  type = ps2x.readType();  \n   ';
    var code = 'ps2x.read_gamepad(false, vibrate);  \n if(ps2x.Button(' + valueps2xxs + ')) {    \n       ' + valueps2x + ' \n   } \n ';
    return code
};


Blockly.Arduino['text_int']=function(block){
    var valuestring_int_block = Blockly.Arduino.valueToCode(block, 'string-int-block', Blockly.Arduino.ORDER_ATOMIC);
    var code = valuestring_int_block + '.toInt()';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
};


Blockly.Arduino['ar_vl53l0']=function(block){
    Blockly.Arduino.includes_['includes_ar_vl53l0'] = '#include <VL53L0X.h>   \n ';
    Blockly.Arduino.variables_['variables_ar_vl53l0'] = 'VL53L0X sensor;  \n ';
    Blockly.Arduino.setups_['setups_ar_vl53l0']='Wire.begin(); \n  pinMode(A3, OUTPUT); \n digitalWrite(A3, 1); \n  sensor.setTimeout(500); \n  if (!sensor.init()) { while (1) {}} \n  #if defined LONG_RANGE \n  sensor.setSignalRateLimit(0.1); \n  sensor.setVcselPulsePeriod(VL53L0X::VcselPeriodPreRange, 18); \n  sensor.setVcselPulsePeriod(VL53L0X::VcselPeriodFinalRange, 14); \n #endif \n  #if defined HIGH_SPEED \n  sensor.setMeasurementTimingBudget(20000); \n #elif defined HIGH_ACCURACY \n sensor.setMeasurementTimingBudget(200000); \n #endif \n ';
    var code = 'sensor.readRangeSingleMillimeters()';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
};
 ...
 Blockly.Arduino['ar_GY-906']=function(block){
    Blockly.Arduino.includes_['includes_ar_vl53l0'] = ' #include <SparkFunMLX90614.h>  \n ';
    Blockly.Arduino.variables_['variables_ar_vl53l0'] = ' IRTherm therm;  \n ';

    Blockly.Arduino.setups_['setups_ar_vl53l0']='   therm.begin();   \n  therm.setUnit(TEMP_C);  \n ';
    var code = '(therm.read() ? String(therm.object(), 2) : "").toInt()';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
};

 Blockly.Arduino['at_arduino_tex']=function(block){
    var valueat_statement = Blockly.Arduino.statementToCode(block, 'at_statement');
	var asd = "'";
    Blockly.Arduino.variables_['variables_at_arduino_tex'] = 'String incStr = "ArduBlock"; \n  char inc = '+asd+'A'+asd+'; \n  ';
    var code = '  if (mySerial.available()) { \n     inc = mySerial.read(); \n     incStr += inc; \n     if (inc == 0x0A) { \n    '+valueat_statement+' \n      incStr = ""; \n     } \n    } \n '; 
    return code
};

Blockly.Arduino['at_arduino_tex_box']=function(block){
    var valuebt_text = block.getFieldValue('bt_text');
    var code = 'incStr.indexOf("'+valuebt_text+'") >= 0';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
};
 
 Blockly.Arduino['at_arduino_tex_pn']=function(block){
    var valueat_block = Blockly.Arduino.valueToCode(block, 'at_block', Blockly.Arduino.ORDER_ATOMIC);
    var valuebt_text = block.getFieldValue('bt_text');
    var code = 'mySerial.print("'+valuebt_text+'="+String('+valueat_block+')+" \\n");  \n ';
    return code
};
